...
%%%% to populate with interior, convex hull, etc...
\nomenclature[F00]{$\operatorname{card} S$}{Cardinality of a set $S$}
\nomenclature[F01]{$\operatorname{co} S$}{Convex hull of a set $S$}
\nomenclature[F02]{$\operatorname{int} S$}{Interior of a set $S$}

% Combinatorial functions
\nomenclature[G00]{$n"!$}{Factorial of a natural number $n$}
\nomenclature[G01]{$x^{(n)}$}{Rising factorial}
\nomenclature[G02]{$(x)_{n}$}{Falling factorial}
\nomenclature[G03]{$\genfrac{(}{)}{0pt}{0}{n}{k}$}{Binomial coefficient $n$ choose $k$}
\nomenclature[G04]{$\genfrac{[}{]}{0pt}{0}{n}{k}$}{Stirling number of the first kind}
\nomenclature[G05]{$\genfrac{\{}{\}}{0pt}{0}{n}{k}$}{Stirling number of the second kind}
\nomenclature[G06]{$\genfrac{\lfloor}{\rfloor}{0pt}{0}{n}{k}$}{Lah numbers}
\nomenclature[G07]{$B_{n}$}{Bell number}
\nomenclature[G08]{$\delta_{ij}$}{Kronecker delta function}

% Functions & Derivatives
\nomenclature[H00]{$\operatorname{dom} f$}{Domain of a function $f$}
\nomenclature[H01]{$\operatorname{epi} f$}{Epigraph of a function $f$}
\nomenclature[H02]{$\nabla f$}{Derivative of a function $f$}